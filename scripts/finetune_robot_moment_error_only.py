...
class RobotFinetuneDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Extraction logic: features are [Desired(3), Realized(3), Error(3)]
        # We only want the last 3 features (Error xyz)
...
def main():
    ...
    checkpoint_path = os.path.join(CHECKPOINT_DIR, "moment_robot_finetuned_error_only.pt")
