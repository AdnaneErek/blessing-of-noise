...
class RobotTestDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # [seq_len, num_features] -> [num_features, seq_len]
...
def main():
    ...
    # 3. Load Checkpoint
    checkpoint_path = os.path.join("checkpoints", "moment_robot_finetuned.pt")
    ...
    plt.title('Confusion Matrix - MOMENT Model (Window Sliced)')
    ...
    plt.savefig(os.path.join(RESULTS_DIR, 'confusion_matrix_moment_sliced.png'))
    print(f"\n[INFO] Confusion matrix saved to {RESULTS_DIR}/confusion_matrix_moment_sliced.png")
